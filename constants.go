...
const (
	...
	*/
	...
	FEATURE_CTRL_SPORT_COUNT       = 52 // (deprecated)
	FEATURE_CTRL_LPORT_COUNT       = 53 // (deprecated)
	FEATURE_CTRL_ANALOG_COUNT      = 57 // (deprecated)
	FEATURE_SPORT_CONFIG_AVAILABLE = 67 // (deprecated)
	...
	FEATURE_GEN_RCPLUS_AVAILABLE    = 111 // 1: supports rcplus messages
